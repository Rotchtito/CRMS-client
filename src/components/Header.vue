<template>
 ...
 <router-link v-if="isLoggedIn" to="/dashboard" class="hover:text-gray-300">Dashboard</router-link>
        <router-link v-if="!isLoggedIn" to="/" class="hover:text-gray-300">Home</router-link>
        <router-link v-if="!isLoggedIn" to="/register" class="hover:text-gray-300">Police Registration</router-link>
