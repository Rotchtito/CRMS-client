<template>
  <div class="bg-gray-800 text-white p-4 min-h-screen">
    <div v-if="userRole === 'admin'" class="text-2xl font-semibold mb-4">Admin</div>
    ...
    <ul class="space-y-2">
      ...
      <li @click="navigateTo('profile')" class="nav-item bg-blue-700 hover:bg-blue-700">Profile</li>
    </ul>
  </div>
</template>
